...
from spaceflights_example_kedro.pipelines.data_science import create_pipeline as create_ds_pipeline
from spaceflights_example_kedro.pipelines.data_science.nodes import split_data
